...
::: {.page-intro}
**Take-home message:** Across all indicators, nitrogen rate had no detectable effect on plant status or yield in this field. Stalk nitrate was exceptionally high even in the Zero N strips, pointing to a soil with a large natural nitrogen reserve. Under these conditions, current application rates may be higher than necessary. Building soil biological activity through continued cover cropping remains a worthwhile long-term investment, even if the short-term nitrogen benefit is not yet visible.
:::
...
::: {.page-intro}
Corn biomass was collected and analyzed for total nitrogen content.  Each of the 16 plots (4 blocks × 4 N rates) had two sub-samples averaged together. We used a block design (RCBD) to test whether tissue nitrogen differed by N rate, and a linear regression to check if nitrogen in the tissue increased steadily with more N applied.
:::
...
<div class="conc-card teal">
  ...
  Yield was similar across all N rates, ranging from <strong>153.8 to 167.7 bu/ac</strong>.
  No clear pattern was detected as N rate increased, suggesting the soil supplied
  sufficient nitrogen even without fertilizer application.
</div>
