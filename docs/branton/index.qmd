...
::: {.page-intro}
**Take-home message:** Across all nitrogen indicators — Biomass %N, CSNT, and corn yield — the data suggests a consistent response to N rate: higher applied nitrogen was associated with greater tissue N and end-of-season stalk nitrate. However, yield did not follow the same pattern. The 50 lb N/ac strip outperformed the higher 62 lb N/ac rate, suggesting that additional nitrogen beyond a certain point does not translate into more grain. Variable-rate strips showed the lowest yield and stalk nitrate values just above the sufficiency threshold, indicating N may have been the limiting factor in those areas. With soil chemistry in excellent condition but biological activity still developing, continued cover cropping could gradually reduce dependence on applied N.
:::
...
<div class="conclusion-grid">
 ...
 <div class="conc-card teal">
  ...
  The cover crop averaged <strong>2.28% N</strong>. A C:N ratio below ~25 indicates 
  the cover crop should release nitrogen relatively quickly during decomposition, 
...
<div class="conc-card amber">
  ...
  Across N rate groups, tissue nitrogen ranged from <strong>3.57% (25 lb N/ac)</strong> 
  to <strong>4.17% (62 lb N/ac)</strong>. The higher rates tended to show higher tissue N, 
  though with only 1–2 plots per group, formal statistical testing is not appropriate.
</div>

<div class="conc-card pink">
  <div class="conc-title">🌽 Cornstalk Nitrate (CSNT)</div>
  End-of-season stalk nitrate increased with N rate: from <strong>336 ppm (25 lb N/ac)</strong> 
  to <strong>943 ppm (62 lb N/ac)</strong>. All fixed-rate strips are above the 250 ppm deficiency 
  threshold. Variable-rate strips averaged <strong>257 ppm</strong>, just above the threshold.
</div>

<div class="conc-card">
  <div class="conc-title">🌾 Corn Yield</div>
  The 50 lb N/ac strip produced the highest mean yield at <strong>178.1 bu/ac</strong>, 
  outperforming both the higher rate (62 lb N/ac = 170.8 bu/ac) and the variable-rate 
  strips (155.7 bu/ac). This suggests that 50 lb N/ac may be near the economic optimum 
...
<div class="conc-card teal">
  ...
  status but low biological activity. Continued cover cropping could improve organic matter 
  and microbial activity over time, potentially reducing the need for applied N in future seasons.
</div>
'))
```
