  ...
  <div class="lab-topbar__inner">
    <div class="lab-topbar__left">
      ...
      <span class="lab-subtitle">
        Field M5F2S2 &nbsp;|&nbsp; NRate `r gn_nrate_val` lb N/ac &nbsp;|&nbsp;
...
This report summarizes field-season measurements for the **M5F2S2** field. Because this field ran under a single nitrogen rate of 163 lb N/ac with no treatment or control strips, we're not comparing two systems here, instead, 
...
<figure style="margin: 20px 0; text-align: center;">
  ...
  <figcaption style="font-size: 0.82rem; color: #6b7280; margin-top: 8px;">
    <strong>Figure 1.</strong> M5F2S2 field.
  </figcaption>
</figure>
...
p_cc_n <- ggplot(gn_cover, aes(x = factor(Plot), y = TotalN_pct)) +
  ...
  geom_hline(yintercept = cc_sum$mean_N, linetype = "dashed",
             color = col_pink, linewidth = 0.9) +
  annotate("text", x = 2.2, y = cc_sum$mean_N + 0.09,
