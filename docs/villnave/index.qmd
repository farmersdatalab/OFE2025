...
::: {.page-intro}
The map below shows the **corn yield spatial distribution** across Field 3, displayed in quantiles.
:::
...
<div class="conclusion-grid">
  ...
  Treatment plots showed a <strong>12.8% higher NBI</strong> compared to Control
  (76 vs 67.4), indicating that corn plants in cover crop strips had
  significantly better in-season nitrogen status at the time of measurement.
</div>
...
<div class="conc-card amber">
  ...
  The Cornstalk Nitrate Test showed a striking difference: Control at
  <strong>79 ppm</strong>, well below the 250 ppm sufficiency threshold, 
  versus Treatment at <strong>938 ppm</strong>, within the optimal range
  (750–2000 ppm). This suggests that control plots may have experienced
  nitrogen deficiency late in the season, while cover crop strips maintained
  adequate N supply through harvest.
</div>

<div class="conc-card teal">
  <div class="conc-title">🌱 Soil Health</div>
  The overall soil health score of <strong>69/100 (High)</strong> reflects
  good physical structure but low biological activity, particularly Soil
  Respiration (score 16) and Active Carbon (score 34). Continued cover
  cropping could directly address these constraints by feeding soil microbial
  communities and building organic matter over time.
</div>
