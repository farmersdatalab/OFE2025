...
<figure style="margin: 20px 0; text-align: center;">
  ...
  <figcaption style="font-size: 0.82rem; color: #6b7280; margin-top: 8px;">
    <strong>Figure 1.</strong> Field 3 — treatment layout.
...
::: {.page-intro}
**Take-home message:** 
Across all four nitrogen indicators (NBI, Chlorophyll, Biomass %N, and CSNT) corn plants in the cover crop strips consistently showed better nitrogen status than those in 
the control strips. Leaf readings were greener and more nitrogen-sufficient, plant tissue had noticeably more nitrogen, and end-of-season stalk nitrate revealed a clear difference between treatments: control stalks were well below the sufficiency threshold, while cover crop stalks were within the optimal range. Your soil health score is solid overall, but building biological activity through 
continued cover cropping is the clearest path to unlocking even more nitrogen from the soil over time.
:::
...
::: {.page-intro}
The map below shows the **corn yield spatial distribution** across Field 3, displayed in tons per acre.
:::
...
<figure style="margin: 20px 0; text-align: center;">
  <img
    ...
    alt="Field 3 — Corn yield map"
    style="max-width: 70%; border-radius: 8px; border: 1px solid #e5e7eb;
...
::: {.page-intro}
The **Nitrogen Balance Index (NBI)** is measured with the Dualex sensor and reflects the ratio of chlorophyll to flavonoids in the leaf. A higher NBI indicates better nitrogen status, the plant has enough N to build chlorophyll without accumulating excess flavonoids as a stress response. e took two readings per plant and averaged them, then compared the 
cover crop strips against the control strips to see if the cover crop made a difference using a two-sample t-test.The result was statistically significant, meaning the difference we saw is real and not just random field variation. 
:::
...
::: {.page-intro}
Corn biomass was collected and sent for laboratory C:N analysis. This measures the actual nitrogen concentration in the plant tissue, a direct indicator of how much N the plant was able to take up. **Note:** Because we only had a small number of samples per treatment, we can't run 
a full statistical test, but the effect size gives us a good sense of whether the difference is biologically meaningful.
:::
...
::: {.page-intro}
Soil health was assessed using the **Cornell Soil Health Test** (sampled 06/11/2025, Field 3). The overall quality score was **69/100 (High)**. The physical structure of your soil is strong: water holding capacity and surface hardness both came back well. The area to watch 
is biological activity, soil respiration and active carbon scored low, which means the microbial community that breaks down organic matter and cycles nutrients isn't as active as it could be. The good news is that cover cropping directly targets exactly this: feeding soil microbes, adding carbon, and building the biological engine of your soil over time.
:::
...
::: {.page-intro}
**Cumulative precipitation** at your field compared to the all-site average, alongside the weekly drought index from June through November 2025. Your field had one of the wettest seasons across all sites in 2025. Cumulative rainfall reached nearly 600 mm, well above the all-site average, with consistent precipitation from June through September and a strong pulse of rain during late August and early September. Drought stress was essentially 
absent all season, with only a brief Low signal in early November.  
:::
```{=html}
...
<div class="conclusion-grid">
  ...
  Cover crop strips showed a <strong>12.8% higher NBI</strong> compared to the 
control (76 vs 67.4). That means corn plants growing in the cover crop strips 
had significantly better nitrogen status mid-season, a clear and statistically meaningful difference.
</div>

  <div class="conc-card">
  <div class="conc-title">🍃 Chlorophyll Index (Chl)</div>
  Chlorophyll values were also higher in cover crop plots
  (<strong>+6.6%</strong>), consistent with the NBI result.
  Higher chlorophyll reflects greener, more nitrogen-sufficient leaves,
  a direct sign of improved N uptake in the treatment strips.
</div>

<div class="conc-card amber">
  <div class="conc-title">🧪 Biomass Nitrogen (%N)</div>
  Laboratory analysis of corn biomass showed treatment plants had
  <strong>+17.6% more nitrogen</strong> in their tissue (2.286% vs 1.944%). The effect size (Cohens d = -0.57) suggests a meaningful biological difference, although the small sample size prevents  formal statistical testing.
</div>

  <div class="conc-card pink">
  <div class="conc-title">🌽 End-of-Season CSNT</div>
  The stalk nitrate result is the most striking finding of the season. The control 
came in at just <strong>79 ppm</strong>, well below the 250 ppm sufficiency 
threshold, indicating the crop ran short on nitrogen late in the season. The 
cover crop strip came in at <strong>938 ppm</strong>, right in the optimal range 
(750–2,000 ppm). The cover crop appears to have kept nitrogen flowing to the 
plant all the way through harvest.
</div>

<div class="conc-card teal">
  <div class="conc-title">🌱 Soil Health</div>
Your overall soil health score of <strong>69/100 (High)</strong> reflects good 
physical structure but low biological activity, particularly soil respiration 
(score 16) and active carbon (score 34). Continued cover cropping is the most 
direct way to address both: more organic inputs mean more microbial activity, 
which means more nitrogen cycling from the soil itself over time.
</div>
