...
::: {.page-intro}
The map below shows the **corn yield spatial distribution** across Field G7, displayed in quantiles. The blue line marks the field boundary and the red lines separate the treatment strips.
:::
...
<div class="conclusion-grid">
  ...
  <div class="conc-card teal">
    ...
    <strong>Treatment</strong> plots showed a <strong>0.7% higher NBI</strong> compared to Control (59.9 vs 59.5). This difference was <strong>not statistically significant in in-season nitrogen status between treatments</strong>, suggesting that the timing of sod plowing had minimal impact on early-season plant nitrogen status as measured by NBI.
  </div>

  <div class="conc-card">
    <div class="conc-title">🍃 Chlorophyll Index (Chl)</div>
    Chlorophyll values were <strong>higher in Treatment plots (+9.1%)</strong>. This <strong>statistically significant difference</strong> is consistent with improved nitrogen uptake in Treatment plots. However, the increase in chlorophyll did not correspond to a significant increase in NBI, indicating that while leaves were greener, overall nitrogen balance was not markedly improved.
  </div>

  <div class="conc-card amber">
    <div class="conc-title">🧪 Biomass Nitrogen (%N)</div>
    Laboratory analysis of corn biomass showed <strong>Treatment plants had -3.7% less nitrogen</strong> in their tissue (3.775% vs 3.92%). The effect size suggests a meaningful biological difference, though the small sample size prevents formal statistical testing. 
  </div>

  <div class="conc-card pink">
    <div class="conc-title">🌽 End-of-Season CSNT</div>
    The Cornstalk Nitrate Test showed Control at 661 ppm and Treatment at 771 ppm, showing that the <strong>treatment had sufficient nitrogen at season end</strong>. With only one sample per treatment, this is a descriptive observation.
  </div>
