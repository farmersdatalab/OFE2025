...
::: {.page-intro}
**Take-home message:** The results this season were mixed. Plowing the sod earlier (Treatment) did produce greener, higher-chlorophyll leaves, a sign of better early-season vigor. But that early advantage didn't carry through to overall nitrogen status, tissue nitrogen, or a yield advantage by the end of the season. In fact, yield was slightly lower in the Treatment strips. Both systems kept the crop adequately supplied with nitrogen, Control CSNT came in just below the optimal threshold, Treatment just above it. Your soil is in good shape overall, and this is a question worth revisiting with another season of data.
:::
