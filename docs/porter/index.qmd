...
<div style="background:#fff8e1; border:1px solid #F9C74F; border-left:6px solid #F9C74F;
            border-radius:8px; padding:12px 16px; font-size:0.88rem; color:#555; margin-bottom:8px;">
  📊 <strong>Coming soon:</strong> yield summary statistics and Control vs Treatment comparison charts will be added once the yield CSV data is available.
</div>
```
